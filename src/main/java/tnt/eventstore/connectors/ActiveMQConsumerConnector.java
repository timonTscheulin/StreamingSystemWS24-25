...
public class ActiveMQConsumerConnector implements EventStoreConsumer {
    ...
    private static final Logger log = LoggerFactory.getLogger(ActiveMQConsumerConnector.class);
    ...
    public ActiveMQConsumerConnector() {
