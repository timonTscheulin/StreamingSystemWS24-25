...
import tnt.eventstore.event_contract.vehicle.*;
...
public class VehicleProjector extends BaseProjector {
    ...
    public VehicleProjector(VehicleRepository repository, EventStore store) {
        this.store = store;
    ...
    private void process(StoreVehicleCreated cmd) {
        ...
        repository.createVehicle(cmd.getVehicleId(), cmd.getStartX(), cmd.getStartY());
    }
